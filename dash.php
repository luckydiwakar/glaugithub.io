...
include_once 'dbConnection.php';
echo '<span class="pull-right top title1"><span class="log1" style="color:#fefefe"><span class="glyphicon glyphicon-user" aria-hidden="true" style="color:#fefefe"></span>&nbsp;&nbsp;&nbsp;&nbsp;Hello,</span> <a href="account.php" class="log log1" style="color:#fefefe">'.$name.'</a>&nbsp;|&nbsp;<a href="logout.php?q=account.php" class="log" style="color:#fefefe"><span class="glyphicon glyphicon-log-out" aria-hidden="true" style="color:#fefefe"></span>&nbsp;Signout</button></a></span>';
}?>
    ...
    <div class="navbar-header">
      <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false">
        ...
        <span class="icon-bar"></span>
          ...
          <a class="navbar-brand" href="#"><b>MAIN MENU</b></a>
</div>

    <!-- Collect the nav links, forms, and other content for toggling -->
    <div class="sidebar-expanded d-none d-md-block" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li <?php if(@$_GET['q']==0) echo'class="active"'; ?>><a href="index.php">Home<span class="sr-only">(current)</span></a></li>	
      <li class="dropdown <?php if(@$_GET['q']==4 || @$_GET['q']==5) echo'active"'; ?>">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">User<span class="caret"></span></a>
          <ul class="dropdown-menu">
          <li <?php if(@$_GET['q']==1) echo'class="active"'; ?>><a href="dash.php?q=1"> All User</a></li>
            <li> <a href="#" data-toggle="modal" data-target="#team">Add User </a></li>
          </ul>
        </li>
        <li class="dropdown <?php if(@$_GET['q']==4 || @$_GET['q']==5) echo'active"'; ?>">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Add fess<span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a href="dash.php?q=4">Add fess </a></li>
            <li><a href="dash.php?q=5">Remove fess</a></li>
...
<tr><td><b>S.N.</b></td><td><b>Name</b></td><td><b>Email</b></td><td><b>Fess</b></td><td><b>Due</b></td><td></td></tr>';
$c=1;
...
<div class="modal fade title1 modal-title" id="team">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
        <h4 class="modal-title" style="font-family:'typo' "><span style="color:orange">Add</span></h4>
<!-- Text input-->
<div class="form-group">
  <label class="col-md-12 control-label" for="name"></label>  
  <div class="col-md-12">
